...
layout = html.Div([
        ...
        html.H1("Select a Method from Check-Boxes  to Explore Overall Statistics of Dataset",  style={
            'textAlign': 'center',
            #'color': colors['text']
        }
),
        html.H2("Select Overall Statistics of Dataset of your Interest:",  style={
            'textAlign': 'center',
            #'color': colors['text']
        }
),
