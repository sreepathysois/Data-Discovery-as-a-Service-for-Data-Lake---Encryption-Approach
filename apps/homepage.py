...
from apps import dashboard, dashboard2, exploreview, overallstat, statselection, overviewstat, datasetselect, univariatestat, bivariatestat, completestat, homepage 
...
layout = html.Div([
    ...
    html.Div(children=[
    html.H1(
        children='Welcome to Data Lake Data Discovery Service',
        style={
            'textAlign': 'center',
            'color': colors['text']
        }
    ...
    html.H2(children='Interactive Data Description Visualization Web Dashboard', style={
        'textAlign': 'center',
        'color': colors['text']
 }),
    ...
    html.Div([
        html.Div(children=[
            html.H3(children='Discover your Data of Intrest under partical Category or Domain',
            style={
            'textAlign': 'center',
            'color': colors['text']
        }), 
